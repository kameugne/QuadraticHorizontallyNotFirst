...
public class TimeLineNotFirstConstraint extends AdjustmentsPropagator {
    ...
    public TimeLineNotFirstConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            int[] estprime;
            int[] estprime_negative;
            TimeLineNotFirst tl = new TimeLineNotFirst(tasks, capacity);
            TimeLineNotFirst tl_negative = new TimeLineNotFirst(negativeTasks, capacity);
            //The makespan is filtered
            if(tl.makespan > makespan.getLB())
                makespan.updateLowerBound(tl.makespan, this);
            estprime = tl.filterWithTimeline();
            estprime_negative = tl_negative.filterWithTimeline();
