...
public class ThetaTreeNotFirstConstraint extends AdjustmentsPropagator {
    ...
    public ThetaTreeNotFirstConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            ThetaTreeNotFirst tt = new ThetaTreeNotFirst(tasks, capacity);
            ThetaTreeNotFirst tt_negative = new ThetaTreeNotFirst(negativeTasks, capacity);

            //The makespan is filtered
            if(tt.makespan > makespan.getLB())
                makespan.updateLowerBound(tt.makespan, this);
            int[] estprime = tt.filterWithTimeline();
            int[] estprime_negative = tt_negative.filterWithTimeline();
            for (int i = 0; i < nbTasks; i++)
            {
