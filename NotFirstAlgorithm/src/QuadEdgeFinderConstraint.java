...
public class QuadEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public QuadEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            QuadEdgeFinder ef = new QuadEdgeFinder(tasks, capacity);
            QuadEdgeFinder ef_negative = new QuadEdgeFinder(negativeTasks, capacity);
