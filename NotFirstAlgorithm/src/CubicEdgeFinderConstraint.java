...
public class CubicEdgeFinderConstraint extends AdjustmentsPropagator {
    ...
    public CubicEdgeFinderConstraint(IntVar[] startingTimes_makespan, IntVar[] endingTimes, Integer[] heights, Integer[] processingTimes, int capacity) {
    ...
    public void propagate(int evtmask) throws ContradictionException {
        ...
        do
        {
            ...
            CubicEdgeFinder ef = new CubicEdgeFinder(tasks, capacity);
            CubicEdgeFinder ef_negative = new CubicEdgeFinder(negativeTasks, capacity);
